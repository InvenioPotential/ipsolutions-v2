...
const AddNonRecur = () => {
    ...
    const handleStatusInput = (input: any) => {
                    ...
                    <div className='grid w-74 gap-5 grid-cols-2'>
                        ...
                        <div className='col-span-2'>
                            ...
                            <div className='*:p-2 *:m-2 *:bg-gray-200 *:rounded-lg  flex justify-center overflow-auto'>
                                <input type='radio' id='status-ongoing' name='status' value='ongoing' onChange={e => setStatusInput(e.target.value)}
                                       defaultChecked/>
                                <label htmlFor='status-ongoing'
                                       className='rounded-lg p-2 hover:bg-green-100 focus:bg-green-200 bg-gray-200'>
                                    ON-GOING
                                </label>

                                <input type='radio' id='status-completed' name='status' value='completed' className="focus:bg-green-200" onChange={e => setStatusInput(e.target.value)}/>
                                <label htmlFor='status-completed'
                                       className='rounded-lg p-2 hover:bg-green-100  bg-gray-200'>
                                    COMPLETED
                                </label>
