            ...
            <div className=' min-h-screen rounded-md p-3 bg-gradient-to-r from-green-500  to-sky-500 text-gray-500'>
              <div className='mx-auto overflow-auto lg:h-auto rounded-md p-2 sm:m-1 md:m-1 m-5'>
                <div className='overflow-auto grid grid-rows-2 lg:grid-cols-4 gap-4 md:grid-cols-1 sm:grid-cols-1'>
                  <div className='grid-cols-subgrid col-span-3 row-span-2'>
                  ...
                  <div className='p-2 rounded-md lg:grid-cols-subgrid lg:col-span-1 md:col-span-0 sm:col-span-0 bg-white'>
                  Notes
                  </div>
                  <div className='p-2 rounded-md lg:grid-cols-subgrid lg:col-span-1 md:col-span-0 sm:col-span-0 bg-white'>
