    ...
    import { unstable_revalidate } from 'next/cache';
    ...
    const EditNonRecur = ({taskId} : {taskId : any}) => {
        ...
        const [taskData, setTask] = useState<item[] | null>([]); // State for storing the task data
        ...
        const [currentUser, setCurrentUser] = useState<any>(null); // State for storing the current user
        const [taskOwner, setTaskOwner] = useState<any>(null); // State for storing the current user
        ...
        console.log("AM I OWNER OF THIS TASK ? "  + canEditTask());
                    ...
                    <div className='grid w-74 gap-5 grid-cols-2'>
                        ...
                        <p>DUE DATE:</p>
                            <div className='w-auto'>
                                 <DatePickers edit={canEditTask()} defaultDate={dateInput} setDateInput={handleDateInput}  />
                            </div>
                        </div>
                        <div className='col-span-2 w-full items-center flex justify-between'>
                            <p>TASK:</p>
