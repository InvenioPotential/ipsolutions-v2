        ...
        const fetchTasks = async () => {
            try {
                ...
                const upcomingTasks = data.filter(task => {
                    // Check if start date exists and is within the next three days
                    if (task.startDate) {
                    ...
                    // Exclude tasks with empty start date
                    return false;
                });
                            ...
                            <div className='m-3 h-44 text-gray-600 text-sm'>
                                {/* <div>
                                    ...
                                    <div
                                        ...
                                        {tasks?.map(task => (
                                            <div key={task.id}
                                                 className='col-span-2 bg-gray-100 rounded-md hover:shadow-sm'>
                                                <div className='p-2'>
